...
- Added **snapshot tools** for control system analysis;
- Major improvements in **Data Report**, including precision control, font selection, CSV export and clipboard copy;
