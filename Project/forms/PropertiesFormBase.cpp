    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    wxBoxSizer* boxSizer1367 = new wxBoxSizer(wxVERTICAL);
    m_panelGeneral->SetSizer(boxSizer1367);
    
    wxGridSizer* gridSizer12126684 = new wxGridSizer(0, 2, 0, 0);
    
    boxSizer1367->Add(gridSizer12126684, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl3_16785 = new wxBoxSizer(wxVERTICAL);
    
    gridSizer12126684->Add(boxSizerLvl3_16785, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    ...
    boxSizerLvl3_16785->Add(m_staticTextLanguage, 0, wxLEFT|wxRIGHT|wxTOP|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    ...
    boxSizerLvl3_16785->Add(m_choiceLanguage, 0, wxLEFT|wxRIGHT|wxBOTTOM|wxEXPAND, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl3_27088 = new wxBoxSizer(wxVERTICAL);
    
    gridSizer12126684->Add(boxSizerLvl3_27088, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    ...
    boxSizerLvl3_27088->Add(m_staticTextTheme, 0, wxLEFT|wxRIGHT|wxTOP|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    ...
    boxSizerLvl3_27088->Add(m_choiceTheme, 0, wxLEFT|wxRIGHT|wxBOTTOM|wxEXPAND, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl3_37391 = new wxBoxSizer(wxVERTICAL);
    
    gridSizer12126684->Add(boxSizerLvl3_37391, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    ...
    boxSizerLvl3_37391->Add(m_staticTextPlotLib, 0, wxLEFT|wxRIGHT|wxTOP|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    ...
    boxSizerLvl3_37391->Add(m_choicePlotLib, 0, wxLEFT|wxRIGHT|wxBOTTOM|wxEXPAND, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl3_2147694 = new wxBoxSizer(wxVERTICAL);
    
    gridSizer12126684->Add(boxSizerLvl3_2147694, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    m_staticTextSize = new wxStaticText(m_panelGeneral, wxID_ANY, _("Label font"), wxDefaultPosition, wxDLG_UNIT(m_panelGeneral, wxSize(-1,-1)), 0);
    
    boxSizerLvl3_2147694->Add(m_staticTextSize, 0, wxLEFT|wxRIGHT|wxTOP|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    ...
    boxSizerLvl3_2147694->Add(m_fontPickerText, 0, wxLEFT|wxRIGHT|wxBOTTOM|wxEXPAND, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl3_217997 = new wxBoxSizer(wxVERTICAL);
    
    gridSizer12126684->Add(boxSizerLvl3_217997, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    ...
    boxSizerLvl3_217997->Add(m_staticTextATPFolder, 0, wxLEFT|wxRIGHT|wxTOP|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    ...
    boxSizerLvl3_217997->Add(m_filePickerATPFolder, 0, wxLEFT|wxRIGHT|wxBOTTOM|wxEXPAND, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl3_21182100 = new wxBoxSizer(wxVERTICAL);
    ...
    boxSizer1331->Add(boxSizerLvl3_27, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    m_staticTextVoltage = new wxStaticText(m_panelBusbar, wxID_ANY, _("Voltage"), wxDefaultPosition, wxDLG_UNIT(m_panelBusbar, wxSize(-1,-1)), 0);
    
    boxSizerLvl3_27->Add(m_staticTextVoltage, 0, wxLEFT|wxRIGHT|wxTOP|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl4_59 = new wxBoxSizer(wxHORIZONTAL);
    
    boxSizerLvl3_27->Add(boxSizerLvl4_59, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    m_textCtrlVoltage = new wxTextCtrl(m_panelBusbar, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panelBusbar, wxSize(-1,-1)), 0);
    #if wxVERSION_NUMBER >= 3000
    m_textCtrlVoltage->SetHint(wxT(""));
    #endif
    
    boxSizerLvl4_59->Add(m_textCtrlVoltage, 1, wxLEFT|wxRIGHT|wxBOTTOM|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    m_staticTextFreqUnit11 = new wxStaticText(m_panelBusbar, wxID_ANY, _("kV"), wxDefaultPosition, wxDLG_UNIT(m_panelBusbar, wxSize(-1,-1)), 0);
    
    boxSizerLvl4_59->Add(m_staticTextFreqUnit11, 0, wxLEFT|wxRIGHT|wxBOTTOM|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl3_27102 = new wxBoxSizer(wxVERTICAL);
    
    boxSizer1331->Add(boxSizerLvl3_27102, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    m_staticTextColorPick = new wxStaticText(m_panelBusbar, wxID_ANY, _("Color"), wxDefaultPosition, wxDLG_UNIT(m_panelBusbar, wxSize(-1,-1)), 0);
    
    boxSizerLvl3_27102->Add(m_staticTextColorPick, 0, wxLEFT|wxRIGHT|wxTOP|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    m_colourPickerBus = new wxColourPickerCtrl(m_panelBusbar, wxID_ANY, *wxBLACK, wxDefaultPosition, wxDLG_UNIT(m_panelBusbar, wxSize(-1,-1)), wxCLRP_DEFAULT_STYLE);
    
    boxSizerLvl3_27102->Add(m_colourPickerBus, 0, wxLEFT|wxRIGHT|wxBOTTOM|wxEXPAND, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizer1397 = new wxBoxSizer(wxVERTICAL);
    
    boxSizer1331->Add(boxSizer1397, 1, wxALL|wxEXPAND, WXC_FROM_DIP(5));
    
    m_buttonAddVoltage = new wxButton(m_panelBusbar, wxID_ANY, _("Add / Update"), wxDefaultPosition, wxDLG_UNIT(m_panelBusbar, wxSize(-1,-1)), 0);
    
    boxSizer1397->Add(m_buttonAddVoltage, 0, wxBOTTOM|wxEXPAND, WXC_FROM_DIP(5));
    
    m_buttonRemoveVoltage = new wxButton(m_panelBusbar, wxID_ANY, _("Remove"), wxDefaultPosition, wxDLG_UNIT(m_panelBusbar, wxSize(-1,-1)), 0);
    
    boxSizer1397->Add(m_buttonRemoveVoltage, 0, wxBOTTOM|wxEXPAND, WXC_FROM_DIP(5));
    
    m_buttonDefaultVoltages = new wxButton(m_panelBusbar, wxID_ANY, _("Default"), wxDefaultPosition, wxDLG_UNIT(m_panelBusbar, wxSize(-1,-1)), 0);
    
    boxSizer1397->Add(m_buttonDefaultVoltages, 0, wxBOTTOM|wxEXPAND, WXC_FROM_DIP(5));
    ...
    m_buttonDefaultVoltages->Bind(wxEVT_COMMAND_BUTTON_CLICKED, &GeneralPropertiesFormBase::OnButtonDefaultVoltages, this);
...
GeneralPropertiesFormBase::~GeneralPropertiesFormBase()
{
    ...
    m_buttonDefaultVoltages->Unbind(wxEVT_COMMAND_BUTTON_CLICKED, &GeneralPropertiesFormBase::OnButtonDefaultVoltages, this);
