...
protected:
    ...
    wxStaticText* m_staticTextFreqUnit11;
    wxStaticText* m_staticTextColorPick;
    wxColourPickerCtrl* m_colourPickerBus;
    wxButton* m_buttonAddVoltage;
    wxButton* m_buttonRemoveVoltage;
    wxButton* m_buttonDefaultVoltages;
    wxButton* m_buttonOK;
...
protected:
    ...
    virtual void OnButtonDefaultVoltages(wxCommandEvent& event) { event.Skip(); }
...
public:
    ...
    wxStaticText* GetStaticTextFreqUnit11() { return m_staticTextFreqUnit11; }
    wxStaticText* GetStaticTextColorPick() { return m_staticTextColorPick; }
    wxColourPickerCtrl* GetColourPickerBus() { return m_colourPickerBus; }
    wxButton* GetButtonAddVoltage() { return m_buttonAddVoltage; }
    wxButton* GetButtonRemoveVoltage() { return m_buttonRemoveVoltage; }
    wxButton* GetButtonDefaultVoltages() { return m_buttonDefaultVoltages; }
    wxPanel* GetPanelBusbar() { return m_panelBusbar; }
