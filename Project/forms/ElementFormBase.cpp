    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_staticTextTurnsRatio->SetToolTip(_("This field is disabled when the on-load tap changer is enabled."));
    ...
    m_textCtrlTurnRatio->SetToolTip(_("This field is disabled when the on-load tap changer is enabled."));
    #if wxVERSION_NUMBER >= 3000
    ...
    m_panelTapChanger = new wxPanel(m_notebook, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_notebook, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    m_notebook->AddPage(m_panelTapChanger, _("On-load tap changer (OLTC)"), false);
    
    wxBoxSizer* boxSizerLvl2_22 = new wxBoxSizer(wxVERTICAL);
    m_panelTapChanger->SetSizer(boxSizerLvl2_22);
    
    m_checkEnableTapChanger = new wxCheckBox(m_panelTapChanger, wxID_ANY, _("Enable on-load tap changer"), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    m_checkEnableTapChanger->SetValue(false);
    
    boxSizerLvl2_22->Add(m_checkEnableTapChanger, 0, wxALL, WXC_FROM_DIP(5));
    
    wxStaticBoxSizer* staticBoxSizerGroundImpedances11 = new wxStaticBoxSizer( new wxStaticBox(m_panelTapChanger, wxID_ANY, _("OLTC parameters")), wxVERTICAL);
    
    boxSizerLvl2_22->Add(staticBoxSizerGroundImpedances11, 0, wxALL|wxEXPAND, WXC_FROM_DIP(5));
    
    wxGridSizer* gridSizerLvl3_412 = new wxGridSizer(0, 2, 0, 0);
    
    staticBoxSizerGroundImpedances11->Add(gridSizerLvl3_412, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl4_1013 = new wxBoxSizer(wxVERTICAL);
    
    gridSizerLvl3_412->Add(boxSizerLvl4_1013, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    m_staticTextControlledBus = new wxStaticText(m_panelTapChanger, wxID_ANY, _("Control bus"), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    
    boxSizerLvl4_1013->Add(m_staticTextControlledBus, 0, wxLEFT|wxRIGHT|wxTOP|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    wxArrayString m_choiceControlledBusArr;
    m_choiceControlledBus = new wxChoice(m_panelTapChanger, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), m_choiceControlledBusArr, 0);
    
    boxSizerLvl4_1013->Add(m_choiceControlledBus, 0, wxLEFT|wxRIGHT|wxBOTTOM|wxEXPAND, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl4_726 = new wxBoxSizer(wxVERTICAL);
    
    gridSizerLvl3_412->Add(boxSizerLvl4_726, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    m_staticTextTargetVoltage = new wxStaticText(m_panelTapChanger, wxID_ANY, _("Reference voltage (Vset)"), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    
    boxSizerLvl4_726->Add(m_staticTextTargetVoltage, 0, wxLEFT|wxRIGHT|wxTOP|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl5_428 = new wxBoxSizer(wxHORIZONTAL);
    
    boxSizerLvl4_726->Add(boxSizerLvl5_428, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    m_textCtrlTargetVoltage = new wxTextCtrl(m_panelTapChanger, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    #if wxVERSION_NUMBER >= 3000
    m_textCtrlTargetVoltage->SetHint(wxT(""));
    #endif
    
    boxSizerLvl5_428->Add(m_textCtrlTargetVoltage, 1, wxLEFT|wxRIGHT|wxBOTTOM|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    m_staticTextPU1 = new wxStaticText(m_panelTapChanger, wxID_ANY, _("p.u."), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    
    boxSizerLvl5_428->Add(m_staticTextPU1, 0, wxALL, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl4_72646 = new wxBoxSizer(wxVERTICAL);
    
    gridSizerLvl3_412->Add(boxSizerLvl4_72646, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    m_staticTextMinTap = new wxStaticText(m_panelTapChanger, wxID_ANY, _("Minimum tap"), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    
    boxSizerLvl4_72646->Add(m_staticTextMinTap, 0, wxLEFT|wxRIGHT|wxTOP|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl5_42848 = new wxBoxSizer(wxHORIZONTAL);
    
    boxSizerLvl4_72646->Add(boxSizerLvl5_42848, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    m_textCtrlMinTap = new wxTextCtrl(m_panelTapChanger, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    #if wxVERSION_NUMBER >= 3000
    m_textCtrlMinTap->SetHint(wxT(""));
    #endif
    
    boxSizerLvl5_42848->Add(m_textCtrlMinTap, 1, wxLEFT|wxRIGHT|wxBOTTOM|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    m_staticTextPU3 = new wxStaticText(m_panelTapChanger, wxID_ANY, _("p.u."), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    
    boxSizerLvl5_42848->Add(m_staticTextPU3, 0, wxALL, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl4_72651 = new wxBoxSizer(wxVERTICAL);
    
    gridSizerLvl3_412->Add(boxSizerLvl4_72651, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    m_staticTextMaxTap = new wxStaticText(m_panelTapChanger, wxID_ANY, _("Maximum tap"), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    
    boxSizerLvl4_72651->Add(m_staticTextMaxTap, 0, wxLEFT|wxRIGHT|wxTOP|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl5_42853 = new wxBoxSizer(wxHORIZONTAL);
    
    boxSizerLvl4_72651->Add(boxSizerLvl5_42853, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    m_textCtrlMaxTap = new wxTextCtrl(m_panelTapChanger, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    #if wxVERSION_NUMBER >= 3000
    m_textCtrlMaxTap->SetHint(wxT(""));
    #endif
    
    boxSizerLvl5_42853->Add(m_textCtrlMaxTap, 1, wxLEFT|wxRIGHT|wxBOTTOM|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    m_staticTextPU4 = new wxStaticText(m_panelTapChanger, wxID_ANY, _("p.u."), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    
    boxSizerLvl5_42853->Add(m_staticTextPU4, 0, wxALL, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl4_72631 = new wxBoxSizer(wxVERTICAL);
    
    gridSizerLvl3_412->Add(boxSizerLvl4_72631, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    m_staticTextDeadband = new wxStaticText(m_panelTapChanger, wxID_ANY, _("Voltage deadband"), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    
    boxSizerLvl4_72631->Add(m_staticTextDeadband, 0, wxLEFT|wxRIGHT|wxTOP|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl5_42833 = new wxBoxSizer(wxHORIZONTAL);
    
    boxSizerLvl4_72631->Add(boxSizerLvl5_42833, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    m_textCtrlDeadband = new wxTextCtrl(m_panelTapChanger, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    #if wxVERSION_NUMBER >= 3000
    m_textCtrlDeadband->SetHint(wxT(""));
    #endif
    
    boxSizerLvl5_42833->Add(m_textCtrlDeadband, 1, wxLEFT|wxRIGHT|wxBOTTOM|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    m_staticTextPU2 = new wxStaticText(m_panelTapChanger, wxID_ANY, _("p.u."), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    
    boxSizerLvl5_42833->Add(m_staticTextPU2, 0, wxALL, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl4_72656 = new wxBoxSizer(wxVERTICAL);
    
    gridSizerLvl3_412->Add(boxSizerLvl4_72656, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    m_checkDiscreteTap = new wxCheckBox(m_panelTapChanger, wxID_ANY, _("Use discrete tap steps"), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    m_checkDiscreteTap->SetValue(false);
    
    boxSizerLvl4_72656->Add(m_checkDiscreteTap, 0, wxLEFT|wxRIGHT|wxTOP, WXC_FROM_DIP(5));
    
    wxBoxSizer* boxSizerLvl5_42858 = new wxBoxSizer(wxHORIZONTAL);
    
    boxSizerLvl4_72656->Add(boxSizerLvl5_42858, 0, wxEXPAND, WXC_FROM_DIP(5));
    
    m_textCtrlTapStep = new wxTextCtrl(m_panelTapChanger, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    #if wxVERSION_NUMBER >= 3000
    m_textCtrlTapStep->SetHint(wxT(""));
    #endif
    
    boxSizerLvl5_42858->Add(m_textCtrlTapStep, 1, wxLEFT|wxRIGHT|wxBOTTOM|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    m_staticTextPU15 = new wxStaticText(m_panelTapChanger, wxID_ANY, _("p.u."), wxDefaultPosition, wxDLG_UNIT(m_panelTapChanger, wxSize(-1,-1)), 0);
    
    boxSizerLvl5_42858->Add(m_staticTextPU15, 0, wxALL, WXC_FROM_DIP(5));
    ...
    // Connect events
    m_checkEnableTapChanger->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED, &TransformerFormBase::OnEnableTapChangerCheck, this);
    m_checkDiscreteTap->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED, &TransformerFormBase::OnDiscreteTapCheck, this);
...
{
    m_checkEnableTapChanger->Unbind(wxEVT_COMMAND_CHECKBOX_CLICKED, &TransformerFormBase::OnEnableTapChangerCheck, this);
    m_checkDiscreteTap->Unbind(wxEVT_COMMAND_CHECKBOX_CLICKED, &TransformerFormBase::OnDiscreteTapCheck, this);
