...
protected:
    ...
    wxPanel* m_panelTapChanger;
    wxCheckBox* m_checkEnableTapChanger;
    wxStaticText* m_staticTextControlledBus;
    wxChoice* m_choiceControlledBus;
    wxStaticText* m_staticTextTargetVoltage;
    wxTextCtrl* m_textCtrlTargetVoltage;
    wxStaticText* m_staticTextPU1;
    wxStaticText* m_staticTextMinTap;
    wxTextCtrl* m_textCtrlMinTap;
    wxStaticText* m_staticTextPU3;
    wxStaticText* m_staticTextMaxTap;
    wxTextCtrl* m_textCtrlMaxTap;
    wxStaticText* m_staticTextPU4;
    wxStaticText* m_staticTextDeadband;
    wxTextCtrl* m_textCtrlDeadband;
    wxStaticText* m_staticTextPU2;
    wxCheckBox* m_checkDiscreteTap;
    wxTextCtrl* m_textCtrlTapStep;
    wxStaticText* m_staticTextPU15;
    wxButton* m_buttonStability;
    wxButton* m_buttonOK;
    wxButton* m_buttonCancel;

protected:
    virtual void OnEnableTapChangerCheck(wxCommandEvent& event) { event.Skip(); }
    virtual void OnDiscreteTapCheck(wxCommandEvent& event) { event.Skip(); }
    virtual void OnStabilityButtonClick(wxCommandEvent& event) { event.Skip(); }
    virtual void OnOKButtonClick(wxCommandEvent& event) { event.Skip(); }
    virtual void OnCancelButtonClick(wxCommandEvent& event) { event.Skip(); }
...
public:
    ...
    wxPanel* GetPanelFault() { return m_panelFault; }
    wxCheckBox* GetCheckEnableTapChanger() { return m_checkEnableTapChanger; }
    wxStaticText* GetStaticTextControlledBus() { return m_staticTextControlledBus; }
    wxChoice* GetChoiceControlledBus() { return m_choiceControlledBus; }
    wxStaticText* GetStaticTextTargetVoltage() { return m_staticTextTargetVoltage; }
    wxTextCtrl* GetTextCtrlTargetVoltage() { return m_textCtrlTargetVoltage; }
    wxStaticText* GetStaticTextPU1() { return m_staticTextPU1; }
    wxStaticText* GetStaticTextMinTap() { return m_staticTextMinTap; }
    wxTextCtrl* GetTextCtrlMinTap() { return m_textCtrlMinTap; }
    wxStaticText* GetStaticTextPU3() { return m_staticTextPU3; }
    wxStaticText* GetStaticTextMaxTap() { return m_staticTextMaxTap; }
    wxTextCtrl* GetTextCtrlMaxTap() { return m_textCtrlMaxTap; }
    wxStaticText* GetStaticTextPU4() { return m_staticTextPU4; }
    wxStaticText* GetStaticTextDeadband() { return m_staticTextDeadband; }
    wxTextCtrl* GetTextCtrlDeadband() { return m_textCtrlDeadband; }
    wxStaticText* GetStaticTextPU2() { return m_staticTextPU2; }
    wxCheckBox* GetCheckDiscreteTap() { return m_checkDiscreteTap; }
    wxTextCtrl* GetTextCtrlTapStep() { return m_textCtrlTapStep; }
    wxStaticText* GetStaticTextPU15() { return m_staticTextPU15; }
    wxPanel* GetPanelTapChanger() { return m_panelTapChanger; }
    wxNotebook* GetNotebook() { return m_notebook; }
    wxButton* GetButtonStability() { return m_buttonStability; }
    wxButton* GetButtonOK() { return m_buttonOK; }
    wxButton* GetButtonCancel() { return m_buttonCancel; }
