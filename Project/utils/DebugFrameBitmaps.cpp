...
void wxC40F6InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/DebugFrameBitmaps.cpp$C__Users_Pichau_Documents_GitHub_PSP_Project_DebugFrameBitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/DebugFrameBitmaps.cpp$C__Users_Pichau_Documents_GitHub_PSP_Project_DebugFrameBitmaps.xrc"));
}
