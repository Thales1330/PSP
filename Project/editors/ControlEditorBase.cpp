    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_cePanel = new wxPanel(m_panelWorkspace, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panelWorkspace, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    
    boxSizerLvl2_1->Add(m_cePanel, 1, wxEXPAND, WXC_FROM_DIP(5));
    ...
    m_cePanel->Bind(wxEVT_LEFT_DCLICK, &ControlEditorBase::OnDoubleClick, this);
    m_cePanel->Bind(wxEVT_MIDDLE_DOWN, &ControlEditorBase::OnMiddleDown, this);
    m_cePanel->Bind(wxEVT_MIDDLE_UP, &ControlEditorBase::OnMiddleUp, this);
    m_cePanel->Bind(wxEVT_MOTION, &ControlEditorBase::OnMouseMotion, this);
...
ControlEditorBase::~ControlEditorBase()
{
    ...
    m_cePanel->Unbind(wxEVT_LEFT_DCLICK, &ControlEditorBase::OnDoubleClick, this);
    m_cePanel->Unbind(wxEVT_MIDDLE_DOWN, &ControlEditorBase::OnMiddleDown, this);
    m_cePanel->Unbind(wxEVT_MIDDLE_UP, &ControlEditorBase::OnMiddleUp, this);
    m_cePanel->Unbind(wxEVT_MOTION, &ControlEditorBase::OnMouseMotion, this);
