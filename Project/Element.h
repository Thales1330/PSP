...
enum ContextMenuID {
	...
	ID_TXT_THD,
	ID_TXT_ACTIVE_POWER,
	ID_TXT_REACTIVE_POWER,
	ID_TXT_BRANCH_ACTIVE_POWER_1_2,
	ID_TXT_BRANCH_ACTIVE_POWER_2_1,
	ID_TXT_BRANCH_REACTIVE_POWER_1_2,
	ID_TXT_BRANCH_REACTIVE_POWER_2_1,
	ID_TXT_BRANCH_LOSSES,
...
public:
	...
	ElementType GetElementType() { return m_elementType; }
	/**
	...
	void SetParent(Element* parent, int num) { m_parentList[num] = parent; }
	void SetChild(Element* child, int num) { m_childList[num] = child; }
	/**
