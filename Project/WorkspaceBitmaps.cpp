...
void wxC52C4InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/WorkspaceBitmaps.cpp$C__Users_thale_Documents_GitHub_PSP_Project_WorkspaceBitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/WorkspaceBitmaps.cpp$C__Users_thale_Documents_GitHub_PSP_Project_WorkspaceBitmaps.xrc"));
}
