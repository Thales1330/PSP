    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_ribbonButtonBarCircuit->AddButton(ID_RIBBON_GRID, _("Grid & Snap"), wxXmlResource::Get()->LoadBitmap(wxT("grid32")), _("Show grid and snap element positions"), wxRIBBON_BUTTON_TOGGLE);
    
    m_ribbonButtonBarCircuit->AddButton(ID_RIBBON_ALIGN, _("Align"), wxXmlResource::Get()->LoadBitmap(wxT("align32")), _("Align selected elements"), wxRIBBON_BUTTON_NORMAL);
